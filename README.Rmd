...
The goal of PolymodalSpectrumGenerator is to easily generate key groupings of variants of interests in protein sequences. By inputing a set of sequences, and indicating the desired number of groupings, the package will return the desired number of core variant groups, as well as their relation to other variants in a spectrum.
